...
class Timer:
    ...
    def __init__(self):
        ...
        self.isTimerActive = False # mentine statusul de pauza/activ
        self.isTimeUp = False # mentine statusul pentru afisarea mesajului "Time is Up!" la scurgerea timpului
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT: # inchide fereastra
                ...
                if 240 <= self.mouse[0] <= 275 and 100 <= self.mouse[1] <= 135: # incrementeaza orele cu 1
                    ...
                    if self.seconds != 0 or self.minutes != 0 or self.hours != 0: # verifica ca nu e apasat butonul de play cand valorile h:m:s sunt pe 0
